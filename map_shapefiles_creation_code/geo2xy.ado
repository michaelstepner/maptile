*! version 1.0.0plusLambert  25jun2015 Robert Picard, picard@netbox.com
...
*/
	...
	qui nobreak {
		...
		// Snyder, p. 44, equation 7-1; R = 1
		`genrep' `x' = (`lon' * `d2r' - `lambda0') if `touse'
		
		// Snyder, p. 44, equation 7-2; R = 1
...
lat0  = projection's origin (just an offset)
lon0  = projection's origin

...
maptile test, geo(county2000) geofolder($out) ///
	savegraph("$test/county2000_noopt.png") replace
project, creates("$test/county2000_noopt.png") preserve
	
maptile test, geo(county2000) geofolder($out) ///
	conus ///
	savegraph("$test/county2000_conus.png") replace
...
maptile test, geo(county2000) geofolder($out) ///
	stateoutline(medium) ///
	savegraph("$test/county2000_stoutline.png") replace
project, creates("$test/county2000_stoutline.png") preserve

maptile test, geo(county2000) geofolder($out) ///
	conus stateoutline(medium) ///
	savegraph("$test/county2000_conus_stoutline.png") replace
